...
def create_performance_summary_table(
    ...
    csv_path = output_dir / "performance-summary-table.csv"
    html_path = output_dir / "performance-summary-table.html"
    png_path = output_dir / "performance-summary-table.png"

    summary.to_csv(csv_path, index=False)
    summary.to_html(html_path, index=False, border=0)
    create_performance_summary_table_image(summary, png_path)

    return [png_path, csv_path, html_path]
