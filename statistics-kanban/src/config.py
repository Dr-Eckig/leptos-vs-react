...
NORMALITY_HISTOGRAM_RESULTS_DIR = PERFORMANCE_RESULTS_DIR / "normality-histograms"
...
# Histograms for assessing normality
NORMALITY_HISTOGRAM_BINS = "sturges"
NORMALITY_HISTOGRAM_WIDTH = 12
NORMALITY_HISTOGRAM_HEIGHT_PER_BOARD = 3.4
NORMALITY_HISTOGRAM_MIN_HEIGHT = 4.2
NORMALITY_HISTOGRAM_BAR_ALPHA = 0.62
NORMALITY_HISTOGRAM_BAR_EDGE_COLOR = "white"
NORMALITY_HISTOGRAM_NORMAL_COLOR = "#374151"
NORMALITY_HISTOGRAM_MEAN_COLOR = "#7c3aed"
NORMALITY_HISTOGRAM_MEDIAN_COLOR = "#059669"
NORMALITY_HISTOGRAM_FILENAME = "normality-histogram-{action}-{browser}.png"
NORMALITY_HISTOGRAM_TITLE = "Verteilungsform: {action} – {browser}"
NORMALITY_HISTOGRAM_X_LABEL = "Messdauer in Millisekunden"
NORMALITY_HISTOGRAM_Y_LABEL = "Dichte"
NORMALITY_HISTOGRAM_FOOTNOTE = (
    "Shapiro-Wilk-Test mit Holm-Korrektur (α = 0,05). "
    "„Nicht verworfen“ ist kein Nachweis einer Normalverteilung."
)
